### Olá, eu sou Heverton Luiz! 👋

**QA Analyst | Test Automation Engineer**

Tenho um background técnico em desenvolvimento e hoje aplico essa lógica para garantir a qualidade de software através de testes automatizados e estratégias de QA.

- 🔭 **Atualmente:** Focado em Automação de Testes Web e API.
- 🌱 **Estudando:** Aprofundando em **Playwright (JS)** e **Selenium (Java)**.
- 🧩 **Stack Principal:** Robot Framework, Python, SQL, Git e Metodologias Ágeis.
- 😄 **Pronouns:** ele/dele
...
<div style="display: inline_block"><br>
  ...
  <br><br>
  <img src="https://img.shields.io/badge/-Playwright-2EAD33?style=for-the-badge&logo=playwright&logoColor=white" target="_blank">
  <img src="https://img.shields.io/badge/-Robot%20Framework-00C0B5?style=for-the-badge&logo=robot-framework&logoColor=white" target="_blank">
